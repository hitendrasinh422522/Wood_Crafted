<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="Wood_Crafted.WebForm7" %>
...
<div class="untree_co-section">
      ...
      <div class="block">
        <div class="row justify-content-center">
          ...
          <div class="col-md-8 col-lg-8 pb-4">
            ...
            <form>
           <asp:Panel ID="pnlContactForm" runat="server" CssClass="container">
    <div class="row">
        <div class="col-6">
            <div class="form-group">
                <asp:Label ID="lblFName" runat="server" AssociatedControlID="txtFName" CssClass="text-black" Text="First name"></asp:Label>
                <asp:TextBox ID="txtFName" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
        </div>
        <div class="col-6">
            <div class="form-group">
                <asp:Label ID="lblLName" runat="server" AssociatedControlID="txtLName" CssClass="text-black" Text="Last name"></asp:Label>
    ...
    <div class="form-group">
        <asp:Label ID="lblEmail" runat="server" AssociatedControlID="txtEmail" CssClass="text-black" Text="Email address"></asp:Label>
        <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control" TextMode="Email"></asp:TextBox>
    </div>

    <div class="form-group mb-5">
        <asp:Label ID="lblMessage" runat="server" AssociatedControlID="txtMessage" CssClass="text-black" Text="Message"></asp:Label>
        <asp:TextBox ID="txtMessage" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="5" Columns="30"></asp:TextBox>
    </div>

    <asp:Button ID="btnSend" runat="server" Text="Send Message" CssClass="btn btn-primary-hover-outline" OnClick="btnSend_Click"  />
</asp:Panel>
