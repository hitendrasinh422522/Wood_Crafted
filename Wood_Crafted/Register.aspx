<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Wood_Crafted.WebForm2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        ...
        /* Buttons */
        input[type="submit"], input[type="button"], .aspNet-Button {
            padding: 10px 20px;
            margin: 5px;
            border: none;
            border-radius: 6px;
    ...
    <center>
        ...
        <table border="0">
            ...
            <tr>
                <td>Gender</td>
                <td>
                    <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal" CssClass="aspNet-RadioButtonList">
            ...
            <tr>
                <td></td>
                <td>
                    <asp:Button ID="Button1" runat="server" Text="Signup" OnClick="Button1_Click" CssClass="aspNet-Button" />
                    <br />You have Also Account so please login:
            ...
            <div class="row g-5 mb-5">
                <div class="col-lg-4">
                    <div class="mb-4 footer-logo-wrap">
                        <a href="#" class="footer-logo">WoodCrafted<span>.</span></a></div>
                    <p class="mb-4">
